...
class RDT:
    ...
    def set_language_embed(self):
        GPU = 0
        MODEL_PATH = os.path.join(self.global_path,"t5-v1_1-xxl")
        CONFIG_PATH = os.path.join(self.global_path,"RDT/configs/base.yaml")
    ...
    def make_policy(self,args):
        ...
        # pretrained_text_encoder_name_or_path = "t5-v1_1-xxl"
        pretrained_vision_encoder_name_or_path = os.path.join(self.global_path,"siglip-so400m-patch14-384")
        model = create_model(
            args=args["config"],
